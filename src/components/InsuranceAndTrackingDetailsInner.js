...
const InsuranceAndTrackingDetailsInner = () => {
    ...
    <div className='row justify-content-center'>
      <div className='col-lg-8'>
        <div className='service-details-wrap'>
          <div className='thumb'>
            <img src='assets/img/service-details/insurance-and-tracking-msb-transports.png' alt='Transpro' />
            <div className='icon'>
              <img src='assets/img/service/service-icon-3.png' alt='Transpro' />
            </div>
          </div>
          <h2>{t('insuranceAndTrackingTitle')}</h2>
          <p>{t('insuranceAndTrackingDescription')}</p>
          <br />
          <div className='row'>
            ...
            <div className='col-lg-6 align-self-center'>
              <h4 className='subtitle'>{t('safeguardYourCargo')}</h4>
              <ul className='list-inner-wrap'>
                <li>{t('dedicatedCoverage')}</li>
                <li>{t('flexibleOptions')}</li>
                <li>{t('expertGuidance')}</li>
              </ul>
            </div>
          </div>
          <br />
          <h4 className='subtitle mt-3'>{t('trackYourShipments')}</h4>
          <ul className='list-inner-wrap'>
            <li>{t('realTimeGPSTracking')}</li>
            <li>{t('detailedShipmentInfo')}</li>
            <li>{t('proactiveAlerts')}</li>
          </ul>
          <br />
          <h4 className='subtitle mt-3'>{t('benefits')}</h4>
          <ul className='list-inner-wrap'>
            <li>{t('worryFreeTransportation')}</li>
            <li>{t('reducedRisk')}</li>
          ...
          <div className='video-thumb-wrap pt-1 pb-4'>
            <img src='assets/img/service-details/insurance-and-tracking-for-delivery-shipments-within-montreal.png' alt='Transpro' />
          </div>
...
export default InsuranceAndTrackingDetailsInner;
