            ...
            <div className='col-xl-4 col-lg-6'>
              <div className='widget widget_about'>
                ...
                <div className='details'>
                  <p>
                  Quickly supply car parts, pallets, any sort of delivery to your partners and clients through our transportation services.
                ...
                <ul>
                  <li>
                    <a href='/express-delivery-courier-montreal'>
                      <FaArrowRight /> 2H Express Delivery & Pickup
                    </a>
                  </li>
                  <li>
                    <a href='#'>
