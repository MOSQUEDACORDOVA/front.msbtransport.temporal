    ...
    <div className='row justify-content-center'>
      <div className='col-lg-8'>
        <div className='service-details-wrap'>
          ...
          <h2>{t('returnsSimplifiedTitle')}</h2>
          <p>{t('returnsSimplifiedDescription')}</p>
          <div className='row'>
            ...
            <div className='col-lg-6 align-self-center'>
              ...
              <ul className='list-inner-wrap'>
                <li>{t('easyOnlineReturns')}</li>
                <li>{t('flexibleOptions')}</li>
                <li>{t('trackItAll')}</li>
                <li>{t('getSmarter')}</li>
                <li>{t('saveMoneyAndPlanet')}</li>
              </ul>
            </div>
          </div>
          <br />
          <div id="flexible-solutions">
            <h4 className='subtitle mt-3'>{t('msbPartnerForReturns')}</h4>
            <p>{t('msbPartnerForReturnsDescription')}</p>
          </div>
          <br />
